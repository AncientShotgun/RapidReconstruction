...
public class GreaterReconstructionAmulet extends ReconstructionAmulet {

	
	public static int RestoreAmount;
	public GreaterReconstructionAmulet(String unlocalizedName, String registryName) {
		super(unlocalizedName, registryName);
		setMaxDamage(RapidReconstructionConfigOptions.GreaterAmuletDurability);
		RestoreAmount=RapidReconstructionConfigOptions.GreaterAmuletRestoreAmount;
	}
