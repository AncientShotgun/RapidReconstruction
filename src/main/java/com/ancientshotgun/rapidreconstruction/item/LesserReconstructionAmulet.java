...
public class LesserReconstructionAmulet extends ReconstructionAmulet {

	private static int RestoreAmount;
	public LesserReconstructionAmulet(String unlocalizedName, String registryName) {
		super(unlocalizedName,registryName);
		setMaxDamage(RapidReconstructionConfigOptions.LesserAmuletDurability);
		RestoreAmount=RapidReconstructionConfigOptions.LesserAmuletRestoreAmount;
	}
